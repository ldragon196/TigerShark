...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
  SCB->VTOR = (uint32_t) ETX_APP_FLASH_ADDR;
  /* USER CODE END 1 */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : ACC_SA0_Pin */
  ...
  /*Configure GPIO pins : PB8 PB4 PB3 PB5
                           PB2 PB10 PB12 */
  GPIO_InitStruct.Pin = GPIO_PIN_8|GPIO_PIN_4|GPIO_PIN_3|GPIO_PIN_5
                          |GPIO_PIN_2|GPIO_PIN_10|GPIO_PIN_12;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : FL_CS_Pin FL_HOLD_Pin FL_WP_Pin */
  ...
  /*Configure GPIO pins : CAN_SHDN_Pin WIFI_EN_Pin LIGHT_SENSOR_EN_Pin */
  ...
  /*Configure GPIO pin : VALVE_CTRL_Pin */
  ...
  /*Configure GPIO pin : LCD_MODE_SET12_Pin */
  ...
  /*Configure GPIO pin : LCD_MODE_SET0_Pin */
  ...
  /*Configure GPIO pin : FLASHLIGHT_CTRL_Pin */
  ...
  /*Configure GPIO pins : COM_PW_EN_Pin RF_PW_EN_Pin VALVE_PW_EN_Pin WAKE_PW_EN_Pin
  ...
  /*Configure GPIO pins : WET_SW_Pin MAIN_SW_Pin TAP_SW_Pin */
  GPIO_InitStruct.Pin = WET_SW_Pin|MAIN_SW_Pin|TAP_SW_Pin;
